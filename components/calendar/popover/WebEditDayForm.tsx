...
export default function WebEditDayForm(props: Props) {
  ...
  const form = useForm<z.infer<typeof FormSchema>>({
    ...
    defaultValues: {
      desciption: mode == "edit" ? props.dayDescription : "",
      type: mode == "edit" ? props.dayType : "0",
    },
  });
  ...
  }, [props?.dayDescription, props?.dayType, open]);

  const handleClose = () => {
    form.reset({ desciption: "", type: "none" });
    setOpen(false);
  };
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen} modal={true}>
      <DialogTrigger disabled={!isEditDashboard} className="p-0 mx-0 w-full">
        <Day
      ...
      <DialogContent className="flex flex-col  px-5 py-5 w-[90%] rounded-md ">
                  ...
                  <FormItem className="w-full ">
                    ...
                    <FormControl>
                      <Textarea
                        ...
                        className=" resize-none border border-border h-[200px] focus:border-primary items-start justify-start bg-white"
